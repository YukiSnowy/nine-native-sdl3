...
#define SDL_GAMEPAD_SDFIELD         "sdk>=:"
#define SDL_GAMEPAD_SDFIELD_SIZE    SDL_strlen(SDL_GAMEPAD_SDFIELD)
...
static int SDL_PrivateAddGamepadMapping(const char *mappingString, SDL_GamepadMappingPriority priority)
{
    ...
    { // Extract and verify the SDK version
        ...
        tmp = SDL_strstr(mappingString, SDL_GAMEPAD_SDFIELD);
        if (tmp) {
            tmp += SDL_GAMEPAD_SDFIELD_SIZE;
