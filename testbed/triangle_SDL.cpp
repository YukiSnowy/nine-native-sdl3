// https://github.com/iXit/nine-tests/blob/main/triangle_SDL.cpp
// LICENSE : MIT
...
int main(int argc, char **argv)
{
    ...
    while (!quit)
    {
        ...
        while (SDL_PollEvent(&e) != 0)
        {
            ...
            else if (e.type == SDL_EVENT_KEY_DOWN && e.window.windowID == MainWindowID && e.key.key == SDLK_F11 && !e.key.repeat)
            {
